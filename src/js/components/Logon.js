...
class Logon extends Component {
  ...
  render () {
    ...
    return (
      <Box pad={{horizontal: 'large'}} wrap={true}  full="vertical" texture="url(/vmi/static/img/back2.gif)" >
        <Box style={{marginTop: 200}} align="start" justify="end" pad={{"horizontal": "large", vertical:"large", between:"large"}}>
